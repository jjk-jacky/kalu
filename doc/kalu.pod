...
remove the folder, I<$TMPDIR/kalu-XXXXXX>)
...
list of all I<.pacnew> and I<.pacorig> files created during the sysupgrade.

For I<.pacorig> files, the full /path/to/filename will be specified; For
I<.pacnew> files it will also be followed by an extra parameter consisting of
...
[3] http://jjacky.com/statusnotifier/
