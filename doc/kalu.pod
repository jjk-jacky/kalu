...
=item B<ForceImages = 1>

With GTK+ 3.10 images in menus & buttons have been forcilly removed, as have
been options I<gtk-menu-images> & I<gtk-button-images>. If you're missing them,
this tweak will bring them back in kalu.
