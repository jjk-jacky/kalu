                                                              ...
                                                              gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__STRING_STRING_STRING_STRING) (gpointer     data1,
                                                                         ...
                                                                         gpointer     arg_4,
                                                                         gpointer     data2);
  register GMarshalFunc_BOOLEAN__STRING_STRING_STRING_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gboolean v_return;
                                                       ...
                                                       gpointer      marshal_data)
{
  typedef gboolean (*GMarshalFunc_BOOLEAN__STRING_STRING_STRING) (gpointer     data1,
                                                                  ...
                                                                  gpointer     arg_3,
                                                                  gpointer     data2);
  register GMarshalFunc_BOOLEAN__STRING_STRING_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gboolean v_return;
                                             ...
                                             gpointer      marshal_data)
{
  typedef gint (*GMarshalFunc_INT__STRING_POINTER) (gpointer     data1,
                                                    ...
                                                    gpointer     arg_2,
                                                    gpointer     data2);
  register GMarshalFunc_INT__STRING_POINTER callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  gint v_return;
                                                        ...
                                                        gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_STRING_INT_UINT_UINT) (gpointer     data1,
                                                               ...
                                                               guint        arg_5,
                                                               gpointer     data2);
  register GMarshalFunc_VOID__INT_STRING_INT_UINT_UINT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
                                                               ...
                                                               gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__INT_STRING_STRING_STRING_STRING) (gpointer     data1,
                                                                      ...
                                                                      gpointer     arg_5,
                                                                      gpointer     data2);
  register GMarshalFunc_VOID__INT_STRING_STRING_STRING_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
